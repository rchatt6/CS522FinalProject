...
public class Order implements Comparable<Order>{
   ...
   /* public Order( String orderName, String currStatus, String addressName, String datePlaced, String orderImg , String vendorName,float price) {
        //this.orderID = orderID;
        this.orderName = orderName;
        this.currStatus = currStatus;
        this.addressName = addressName;
    ...
    public Order( String orderName, String currStatus, String addressName, String datePlaced, int image , String vendorName,double price) {
        //this.orderID = orderID;
        this.orderName = orderName;
        this.currStatus = currStatus;
        this.addressName = addressName;
