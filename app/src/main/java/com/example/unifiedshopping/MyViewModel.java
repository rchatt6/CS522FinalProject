...
public class MyViewModel extends ViewModel {
    ...
    private ArrayList<Boolean> switchState;


    public ArrayList<Boolean> getSwitchState() {
        return switchState;
    }

    public void setSwitchState(ArrayList<Boolean> switchState) {
    ...
    public void initSwitchState(ArrayList<Vendor> vendorArrayList) {
        for (Vendor v: vendorArrayList) {
            switchState.add(false);
        }
    }
